...
ifname_w2=$(uci -q get misc.wireless.ifname_2G)
iface_w2=$(uci show wireless | grep -w "ifname='$ifname_w2'" | awk -F"." '{print $2}')

maclist="`uci -q get wireless.${iface_w2}.maclist`"
maclist_format="`echo -n $maclist | sed "s/ /;/g"`"
filter="`uci -q get wireless.${iface_w2}.macfilter`"
